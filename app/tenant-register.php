...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["email"]))){
        ...
        $sql = "SELECT tenant_id FROM tenant WHERE email = ?";
    ...
    if(empty($email_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO tenant (fname,lname, email, password) VALUES (?,?, ?, ?)";
    ...
    <div class="wrapper">
      <div class = 'BlackBox' id ="centre_BlackBox">
        <div class = 'move-Content' id = "move-Content">
          <img src="colourLogo.jpg" width="400" height="350" class = "img-center">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
          ...
          <div class="form-group>">
            ...
            <p>Already have an account? <a href="tenant-login.php">Login here</a>.</p>
              <p>Not a Tenant? <a href="index.html">Go back</a></p>
        </form>
      </div>
    </div>
    </div>
